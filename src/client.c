...
void ssh_disconnect(ssh_session session) {
  ssh_disconnect_with_message(session, SSH2_DISCONNECT_BY_APPLICATION, "Bye Bye");
}
...
*/
void ssh_disconnect_with_message(ssh_session session, uint32_t reason_code, const char* msg) {
