...
/* 1C LLC 11.08.16 Disconnect function with custom reason and message */
LIBSSH_API void ssh_disconnect_with_message(ssh_session session, uint32_t reason_code, const char* msg);
/* 1C LLC */
